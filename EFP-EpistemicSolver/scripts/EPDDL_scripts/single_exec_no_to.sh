...
#USAGE EXAMPLE (from the project root folder): ". scripts/EPDDL_scripts/single_exec_no_to.sh exp/EPDDL/coininthebox/coininthebox.epddl exp/EPDDL/coininthebox/pb1.epddl"
...
bin/efp.out "exp/tmp/$INSTANCENAME" -results_file -check_visited -st POSS > findingplan_comparison.tmp
exit_status=$?;
