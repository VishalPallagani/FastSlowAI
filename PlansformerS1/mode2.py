"""
Mode 3 makes use of CodeT5 (has no prior training done on planning problems)
and continually trains on planning problems from the memory.
At the very initial execution of this code, CodeT5 is downloaded and is fine-tuned on
planning problems from the memory. The model files obtained from this will be written to
the folder "scratch_model_files". From the consequent calls of this code, the model files
obtained from fine-tuning CodeT5 the first time will be used and overwritten as new files
are obtained.
"""
